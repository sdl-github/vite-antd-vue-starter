...
declare global {
  ...
  const useGraphqlRequest: typeof import('./composables/request')['useGraphqlRequest']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useGraphqlRequest: UnwrapRef<typeof import('./composables/request')['useGraphqlRequest']>
