...
import type { UserQueryInput } from '@/api/user'
...
<template>
  <a-card class="search_card flex" :bordered="false">
    <a-input v-model:value="form.username" class="search-item" placeholder="请输入用户名" />
    <a-input v-model:value="form.phone" class="search-item" placeholder="请输入手机" />
    <a-input v-model:value="form.email" class="search-item" placeholder="请输入邮箱" />
